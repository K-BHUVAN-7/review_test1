...
@Component({
  ...
  styleUrl: './utility-bill.component.scss'
})
export class UtilityBillComponent {
  ...
  ngOnInit(): void {
    ...
    this.permissions = this.service.getPermissions({ pathArr: ["Utility Bill"], isNeedBranchList: true, 'permission': ['create', 'view', 'edit', 'delete']});
  ...
  getUtilityBillList(){
    ...
    this.service.postService({'url': '/utility-bill/list', payload, params }).subscribe((res: any) => {
      ...
      if(res.status == 'ok') {
        ...
        this.masterList['utilityBillList'] = res.data;

        console.log('Utility Bill List', this.masterList['utilityBillList']);
  ...
  editBill(index: number) {
    ...
    const bill = this.masterList['utilityBillList'][index];
    ...
    this.confirmationDialog.confirm({
      ...
      if(confrimation){
        ...
        forkJoin({
          ...
          this.service.postService({ 'url': '/utility-bill/create', payload }) : 
        
          this.service.patchService({ 'url': `/utility-bill/${this.editData?._id}`, payload })
  ...
  deliteUtilityBill(data: any) {
    ...
    .then((confirmed: any) => {
      ...
      if (confirmed) {
        ...
        this.service.deleteService('/utility-bill/' + data?._id).subscribe((res: any) => {
  ...
  xlDownload(){
    ...
    this.service.getFile({ "url": "/getUtilityBillExcel", params }).subscribe((res: any) => {
